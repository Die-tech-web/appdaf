Base de donné : Request de creation de table : 
...
Insertion de citoyen : INSERT INTO citoyen (nom, prenom, date_naissance, lieu_naissance, cni, cni_recto_url, cni_verso_url)
VALUES 
